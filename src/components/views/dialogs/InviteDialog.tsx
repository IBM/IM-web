    ...
    public render(): React.ReactNode {
        ...
        if (this.props.kind === InviteKind.Dm) {
            ...
            extraSection = (
                <div className="mx_InviteDialog_section_hidden_suggestions_disclaimer">
                     ...
                     * START
                    */}
                    {SettingsStore.getValue("ibm_showShareRoomDialog") && <p>{_t("invite|suggestions_disclaimer_prompt")}</p>}
                    {/**
                     * END
                     *
                     * IBM CHANGES FOR BRANDING - DO NOT OVERWRITE
            ...
            * START
            */
            if (SettingsStore.getValue("ibm_showShareRoomDialog")) {
                helpText = _t(
        ...
        const usersSection = (
            <React.Fragment>
                 ...
                 * START
                */}
                {SettingsStore.getValue("ibm_showShareRoomDialog") && footer}
                {/**
                 * END
                 *
                 * IBM CHANGES FOR BRANDING - DO NOT OVERWRITE
