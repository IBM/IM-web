...
export class UnwrappedEventTile extends React.Component<EventTileProps, IState> {
    ...
    private renderThreadPanelSummary(): JSX.Element | null {
         ...
         * START
        */
        if (!this.state.thread ||  !SettingsStore.getValue("ibm_enableThreads")) {
        /**
         * END
         *
         * IBM CHANGES FOR BRANDING - DO NOT OVERWRITE
    ...
    private renderThreadInfo(): React.ReactNode {
         ...
         * START
        */
        if (this.state.thread && this.state.thread.id === this.props.mxEvent.getId() && SettingsStore.getValue("ibm_enableThreads")) {
        /**
         * END
         *
         * IBM CHANGES FOR BRANDING - DO NOT OVERWRITE
