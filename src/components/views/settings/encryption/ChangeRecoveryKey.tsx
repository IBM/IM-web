...
import { saveRecoveryKey } from "../../../../utils/KeyBackup";
                        ...
                        try {
                            ...
                            */
                            ...
                            if (SettingsStore.getValue("ibm_enableKeyBackup")) {
                                ...
                                const success = await saveRecoveryKey(recoveryKey.encodedPrivateKey!, accessToken);
                                if (!success) {
                                    throw new Error("Recovery key save failed");
                                }
                            }
