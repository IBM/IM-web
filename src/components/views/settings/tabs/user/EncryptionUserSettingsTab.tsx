    ...
    switch (state) {
        ...
        case "main":
            ...
            */
            ...
            content = (
                <>
                    {SettingsStore.getValue("UIFeature.advancedSettings") && <KeyStoragePanel onKeyStorageDisableClick={() => setState("key_storage_delete")} /> &&
                    ...
                    {SettingsStore.getValue("UIFeature.advancedSettings") && <AdvancedPanel onResetIdentityClick={() => setState("reset_identity_compromised")} />}
                </>
            );
            {
            /**
